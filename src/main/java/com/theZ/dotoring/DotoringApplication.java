...
public class DotoringApplication {
	...
	@Profile("local")
	@Bean
	CommandLineRunner localServerStart(MentiRepository mentiRepository, CertificationRepository certificationRepository, MentoRepository mentoRepository, LetterRepository letterRepository, RoomRepository roomRepository, BCryptPasswordEncoder bCryptPasswordEncoder) {

		List<Certification> certifications = generateCertifications();
	...
	private List<Menti> generateMenties(Certification certification1, Certification certification2) {
		...
		mentis.add(Menti.createMenti("sonny5678", "sonny5678", "sonny5678@naver.com", "sonny5678", "안녕하세요, 저는 짱멋있는 도연입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("전기컴퓨터공학부"), Job.valueOf("정보통신")));
		...
		mentis.add(Menti.createMenti("dorae5678", "dorae5678", "dorae5678@naver.com", "dorae5678", "안녕하세요, 저는 짱멋있는 건형입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("ramen5678", "ramen5678", "ramen5678@naver.com", "ramen5678", "안녕하세요, 저는 짱멋있는 수현입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 3L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("sun5678", "suns5678", "sun5678@naver.com", "sun5678", "안녕하세요, 저는 짱멋있는 수민입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("intel5678", "int5678", "intel5678@naver.com", "intel5678", "안녕하세요, 저는 짱멋있는 종준입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 1L, Major.valueOf("소프트웨어공학과"), Job.valueOf("사정보통신")));
		...
		mentis.add(Menti.createMenti("yardyard", "yard1234", "yard1234@naver.com", "yard1234", "안녕하세요, 저는 짱멋있는 케빈입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 1L, Major.valueOf("가정교육과"), Job.valueOf("건설")));
		mentis.add(Menti.createMenti("sonny1234", "sonny1234", "sonny1234@naver.com", "sonny1234", "안녕하세요, 저는 짱멋있는 쏘니입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("간호학과"), Job.valueOf("경영")));
		...
		mentis.add(Menti.createMenti("yard1234", "yard1234", "yard1234@naver.com", "yard1234", "안녕하세요, 저는 짱멋있는 야드입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 4L, Major.valueOf("건축공학전공"), Job.valueOf("금융")));
		...
		mentis.add(Menti.createMenti("ramen1234", "ramen1234", "ramen1234@naver.com", "ramen1234", "안녕하세요, 저는 짱멋있는 라멘입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 3L, Major.valueOf("건축학부"), Job.valueOf("교육")));
		...
		mentis.add(Menti.createMenti("dfcsard", "dfcs1234", "dfcs1234@naver.com", "dfcs1234", "안녕하세요, 저는 멋있는 디에프씨에스입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		...
		mentis.add(Menti.createMenti("yard1234", "dore1234", "dore1234@naver.com", "dore1234", "안녕하세요, 저는 미친 도레입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 4L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("doraemon", "aaaa1234", "aaaa1234@naver.com", "aaaa1234", "안녕하세요, 저는 짱멋있는 아멘입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 3L, Major.valueOf("산업공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("ramen1234", "ramen1234", "ramen1234@naver.com", "ramen1234", "안녕하세요, 저는 짱멋있는 라멘입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 3L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("junsu111", "junsu111", "junsu111@naver.com", "junsu111", "안녕하세요, 저는 짱멋있는 준수입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 3L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("minji123", "minji123", "minji123@naver.com", "minji123", "안녕하세요, 저는 짱멋있는 민지입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 1L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("dongwan14", "dongwan14", "dongwan14@naver.com", "dongwan14", "안녕하세요, 저는 짱멋있는 동완입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		mentis.add(Menti.createMenti("hongjun14", "hongjun14", "hongjun14@naver.com", "hongjun14", "안녕하세요, 저는 짱멋있는 홍준입니다.", "basicProfile_47838475947393908393.png", List.of(certification1, certification2), "전남대학교", 2L, Major.valueOf("소프트웨어공학과"), Job.valueOf("정보통신")));
		return mentis;
	}
